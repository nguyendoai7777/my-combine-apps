  ...
  template: `
    ...
    <div mat-dialog-content>
      <add-song
        ...
        [mode]="mode"
        [remote]="mode === 'new'"
        [currentEdit]="current ? current : currentSongPlaying"
        (formChange)="onFormChange($event)"
        (saveEdite)="onSaveEdit()"
      />
    </div>
    <div mat-dialog-actions class="actions">
      <div class="px-2 ms-auto">
        ...
        <ng-template #update>
          <button mat-stroked-button [color]="form?.invalid ? 'warn' : 'primary'" [class.invalid-f]="form?.invalid" (click)="onSaveEdit(); instance.addAnSubject(form)">
